  ...
  <div class="row">
    ...
    <div class="col-md-5 select-businnes-cards">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-8 filter_select">
          <select class="selectdetalles selector2" name="pages"  id="pages" onchange="" >
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-8 filter_select">
          <select class="selectdetalles selector2" name="drill"  id="drill" onchange="">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-8 filter_select">
          <select class="selectdetalles selector2" name="binding"  id="binding" onchange="">
            <option value="{{$attr7}}">{{$attr7}}</option>
          </select>
        </div>
      </div>

...
<body>
  <div class="container">
    ...
    <div style="padding: 0% 15% 0% 15%;text-align: center;">
      <h1 class="center">Thank you for purchasing with us!</h1>
      <p style="font-size: 19px;">Hi, {{$datos['cltname']}}. Your order has been received and is now being processing. This are you order details:
      </p>
      <br>
          ...
          <tr>
            <td style="width: 50%; border: 1px gray solid;padding: 5px">
              <div style="float: left;width:30%">
                <img src="{{url('/')}}/upload-products/{{$dt->archivo_a}}" style="width: 80%;padding: 15% 10% 0% 10%"><br>

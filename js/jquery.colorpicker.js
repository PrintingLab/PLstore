...
(function( factory ) {
	...
	var _colorpicker_index = 0,
		...
		_layoutTable = function(layout, callback) {
			...
			return '<table cellspacing="0" cellpadding="0" border="0"><tbody>' + html + '</tbody></table><div id="colorgrid"></div>';
		};
				...
				var that = this,
					...
					html = function () {
						...
						if (inst.options.alpha || (!inst.inline && inst.options.showNoneButton)) {
							...
							if (inst.options.alpha) {
								html += '<input  name="ui-colorpicker-special" id="" class="ui-colorpicker-special-transparent"/><label onclick="dropper()"><img src="./img/icons/dropper.png"></label>';
							}
